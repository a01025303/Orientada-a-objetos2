...
void Admin::adminReserve(Asientos* elAsiento)
{
    cout << "El nombre del admin que reservó el asiento " << elAsiento->getType() << "-" << elAsiento->getLocation() << " es: " << elAsiento->admin_asiento->getNombre() << endl; 
}